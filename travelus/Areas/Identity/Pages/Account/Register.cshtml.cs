        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.HelpDeskUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.HelpDeskUser));
                    }
                    ...
                    {
                        if (role == SD.HelpDeskUser)
                        {
                            await _userManager.AddToRoleAsync(user, SD.HelpDeskUser);
                        }
                        else
                        {
